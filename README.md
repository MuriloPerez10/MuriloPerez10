...
* 🛡️ My name is Murilo and I am an Information Security and Infrastructure professional.
* ☁️ Currently managing and securing Microsoft 365 and Azure environments, focusing on IAM and Zero Trust architecture.
* 📜 Certified Microsoft Security, Compliance, and Identity Fundamentals (SC-900).
* ⚖️ Deeply involved with Security Governance (GRC), implementing policies based on ISO 27001, ISO 37001, and ISO 37301.
* 🐍 Passionate about automation, utilizing Python to optimize security processes and compliance auditing.
* 🇬🇧 Currently focusing on intensive English learning to support my international career goals.
